...
class Settings extends BaseController
{
	...
	{
		$this->form_validation->setRule('timezone', 'timezone', 'required');
		$this->form_validation->setRule('file_size_limit', 'File size limit', 'integer|greater_than_equal_to[0]');
		$this->form_validation->setRule('output_size_limit', 'Output size limit', 'integer|greater_than_equal_to[0]');
		$this->form_validation->setRule('rpp_all', 'results per page (all submissions)', 'integer|greater_than_equal_to[0]');
		$this->form_validation->setRule('rpp_final', 'results per page (final submissions)', 'integer|greater_than_equal_to[0]');
		$this->form_validation->setRule('mail_from', 'email', 'valid_email');
