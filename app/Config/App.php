...
class App extends BaseConfig
{
     ...
     *    http://example.com/
     */
    public string $baseURL = 'http://sharif.localhost/';
     ...
     */
    public string $sessionCookieName = 'shjsession';
     ...
     */
    public string $CSRFTokenName = 'shj_csrf_token';
     ...
     */
    public string $CSRFCookieName = 'shjcsrftoken';
